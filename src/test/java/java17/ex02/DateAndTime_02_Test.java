...
public class DateAndTime_02_Test {
	...
	public void test_localDate_format_with_hour() {
		...
		localDate.format(DateTimeFormatter.ISO_INSTANT);
	}
	...
	public void test_with() {
		...
		LocalDate newLocalDate = localDate.withYear(2015).withMonth(2).withDayOfMonth(5);
		LocalDate result = newLocalDate;
